...
class TodoCollectionController: UICollectionViewController {
...
//        navigationItem.rightBarButtonItem = UIBarButtonItem.init(customView: switchControl)
    ...
    func updateDisplay() {
        reloadDataAndUpdateDisplay(group: "Todo")
    }
                        ...
                        switch result {
                            case .success(let images):
                                ...
                                self.dataSource = .init(collectionView: self.collectionView, cellProvider: { (collectionView, indexPath, item) -> UICollectionViewCell? in
                                    ...
                                    cell.todoNavController = self.navigationController as? TodoNavController
                                    cell.todoCollectionController = self
